...
public class ExamenService {
    ...
    public ExamenDto solicitar(ExamenDto dto) {
        return toDto(examenRepository.save(toEntity(dto)));
    }
    ...
    public ExamenDto cargarResultado(Long id, String resultados, String observaciones) {
        ExamenLaboratorio e = examenRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Examen no encontrado: " + id));
    ...
    private ExamenDto toDto(ExamenLaboratorio e) {
        return ExamenDto.builder()
                .id(e.getId()).mascotaId(e.getMascotaId()).clienteId(e.getClienteId())
                .personalId(e.getPersonalId()).citaId(e.getCitaId())
                .tipoExamen(e.getTipoExamen()).estado(e.getEstado())
                .fechaSolicitud(e.getFechaSolicitud()).fechaResultado(e.getFechaResultado())
                .resultados(e.getResultados()).observaciones(e.getObservaciones())
                .urgente(e.getUrgente()).build();
    }
    ...
    private ExamenLaboratorio toEntity(ExamenDto dto) {
        return ExamenLaboratorio.builder()
                ...
                .tipoExamen(dto.getTipoExamen()).urgente(dto.getUrgente() != null && dto.getUrgente()).build();
    }
}